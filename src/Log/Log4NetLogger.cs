...
namespace Log
{
    public sealed class Log4NetLogger : ILog
    {
        ...
        private static log4net.ILog m_log = LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        ...
        static Log4NetLogger()
        {
            ...
            log4net.Config.XmlConfigurator.Configure(m_defaultRepository, new System.IO.FileInfo(path));
        ...
        public void Debug(String argMessage, Exception exception = null)
        {
        ...
        /// </summary>
        /// <param name="argMessage">信息，可自定义</param>
        public void Error(String argMessage)
        {
        ...
        /// <param name="exception">错误信息</param>
        public void Error(String argCustomErrorMsg, Exception exception)
        {
        ...
        /// </summary>
        /// <param name="argMessage">信息，可自定义</param>
        public void Info(String argMessage)
        {
        ...
        /// <param name="argMessage">信息，可自定义</param>
        /// <param name="exception">错误信息</param>
        public void Fatal(String argMessage, Exception exception = null)
        {
        ...
        /// <param name="argMessage">信息，可自定义</param>
        /// <param name="exception">错误信息</param>
        public void Warn(String argMessage, Exception exception = null)
        {
